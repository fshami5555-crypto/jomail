...
import { Mail, CheckSquare, FileText, GraduationCap, ArrowLeft, Loader2, AlertCircle } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ onSelectApp, onLogin }) => {
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  ...
                  {!app.active && (
                   ...
                   {app.active && (
                    <span className="bg-blue-50 text-blue-600 text-xs px-2 py-1 rounded-full font-medium opacity-0 group-hover:opacity-100 transition-opacity">
                      دخول
                    </span>
                  )}
                </div>
